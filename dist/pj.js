...
var connect_string = function connect_string(s_connect) {
	...
	return '' + (m_connect[1] || H_CONNECT_DEFAULTS.protocol) + '://' + (m_connect[2] || H_CONNECT_DEFAULTS.user) + '@' + (m_connect[3] || H_CONNECT_DEFAULTS.host) + '/' + m_connect[4];
};
